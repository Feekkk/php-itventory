...
// Fetch pending handovers from database
$handovers = [];
...
<div class="container">
    <div class="page-header">
        <div class="header-content">
            <div>
                ...
                <h1>Pending Handovers</h1>
                <p class="page-subtitle">View all pending handover requests</p>
            </div>
        </div>
    </div>
    ...
    <div class="filters-section">
        <form method="GET" action="" class="filters-form">
            ...
            <div class="filter-group">
                ...
                <?php if (!empty($search)): ?>
                    <a href="ViewPending.php" class="clear-btn">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="results-summary">
        <p class="results-count">
            <?php echo count($handovers); ?> pending handover<?php echo count($handovers) !== 1 ? 's' : ''; ?> found
        </p>
    </div>
    ...
    <div class="handovers-list">
        <?php if (empty($handovers)): ?>
            <div class="empty-state">
                ...
                <h3>No Pending Handovers</h3>
                <p>There are no pending handover requests at this time.</p>
            </div>
        <?php else: ?>
